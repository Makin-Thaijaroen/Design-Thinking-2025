...
## 💡 สะท้อนคิด
จากการทำโครงงานครั้งนี้ พวกเราได้เรียนรู้ว่า Web Scraping ไม่ใช่แค่การดึงข้อมูลจากเว็บไซต์ แต่คือการสร้างระบบอัตโนมัติที่ทำงานอย่างรอบคอบ ตั้งแต่การจัดการการโหลดหน้าเว็บ การวิเคราะห์โครงสร้าง HTML ไปจนถึงการทำความสะอาดข้อมูล (Data Cleaning) เพื่อแปลงข้อมูลดิบให้เป็นชุดข้อมูลที่มีโครงสร้างและพร้อมใช้งาน
นอกจากนี้ ยังได้พัฒนาทักษะการเขียนโปรแกรมด้วย Python การพัฒนาเว็บแอปพลิเคชัน และการใช้ GitHub เพื่อทำงานร่วมกันเป็นทีม รวมถึงการวางแผนและแบ่งหน้าที่อย่างเป็นระบบ
สิ่งที่ควรพัฒนาคือการเขียนเงื่อนไขให้รอบคอบมากขึ้น และการจัดการข้อมูลให้ยืดหยุ่น เนื่องจากการเปลี่ยนแปลงรูปแบบข้อมูล เช่น ไฟล์ CSV อาจส่งผลต่อผลลัพธ์ของระบบได้
โดยรวมแล้ว โครงงานนี้ช่วยพัฒนาทั้งทักษะด้านเทคนิคและการทำงานเป็นทีม ซึ่งสามารถนำไปต่อยอดในอนาคตได้อย่างดี
